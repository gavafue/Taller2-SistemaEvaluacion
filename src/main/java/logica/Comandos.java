...
public class Comandos {
    ...
    public void cargarComandos() {
        ...
        //head RF31.
        Comando com12 = new Comando("Mostrar las primeras líneas de un archivo. ", "\nEjemplo: head [opción] [argumento]", null); //admite como opciones “-n [número]” si no se especifica, las primeras 10.
        ...
        //sort RF38 
        // creo que el RF38 se podria redactarse distinto (si estamos a tiempo): La consola permitirá el comando “sort” para mostrar en pantalla las líneas de un archivo de manera ordenada. No hay modificacion en el archivo.
        Comando com14 = new Comando("Para ordenar las líneas de un archivo. ", "\nEjemplo: sort [opciones] [archivo]", null); //opciones disponibles “-n” para ordenar numéricamente.
Comando com15 = new Comando("Para modificar los permisos asignados en un archivo o directorio ", "\nEjemplos: \nchmod rwxrwxrwx arch1\n chmod 555 arch1", null);
        ...
        /*try {
            ...
            while (s.hasNextLine()) {
                ...
                this.agregarComando(tokens[0], new Comando(tokens[1], tokens[2], null)); // el unico que tiene extensiones es el ls x ahora ... y como esta pensado
            }                                                                           // para funcar sin extensiones y por la prog como está hecha no es necesario.
            s.close();
        } catch (IOException e) {
            e.printStackTrace();
        }*/
