...
public class Comandos {
    ...
    public void cargarComandos() {
        ...
        Comando com0 = new Comando(
                ...
                + " - |: concatenar dos comandos y ejecutar el segundo comando si y solo si el primero finaliza correctamente. \n",
        ...
        Comando com16 = new Comando(
                ...
                "\n     Este comando permite tomar la salida de un comando (como 'head', 'tail' o 'ps') y usarla como entrada para otro comando (como 'grep')."
                + "\n     Sintaxis básica:"
                + "\n        comando1 | comando2"
                + "\n"
                + "\n     Ejemplos de uso:"
